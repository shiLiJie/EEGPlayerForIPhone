...
//            [formatterNow setDateFormat:@"YYYYMMdd"];
//            NSString *string = [formatterNow stringFromDate:datenow];
//            
//            NSString *dateString = [NSString stringWithFormat:@"%@%tu%tu00",string,hour,minute];
//            NSMutableString *datestring = [NSMutableString stringWithFormat:@"%@",dateString];
//            
...
//            NSString *secString=@"00";
//            NSString *dayString=@"00";
//            if (dd/3600<1)
//            {
//                minString = [NSString stringWithFormat:@"%ld", dd/60];
//                minString=[NSString stringWithFormat:@"%@分钟hou", minString];
//                secString=[NSString stringWithFormat:@"%ld秒后", dd%60];
//            }
//            if (dd/3600>1&&dd/86400<1)
//            {
//                hourString = [NSString stringWithFormat:@"%ld", dd/3600];
//                hourString=[NSString stringWithFormat:@"%@小时前", hourString];
//                minString = [NSString stringWithFormat:@"%ld", dd%3600/60];
//                minString=[NSString stringWithFormat:@"%@分钟后", minString];
//                secString=[NSString stringWithFormat:@"%ld秒后", dd%3600%60];
//            }
//            if (dd/86400>=1)
//            {
//                dayString = [NSString stringWithFormat:@"%ld", dd/86400];
//                dayString=[NSString stringWithFormat:@"%@天前", dayString];
//                hourString = [NSString stringWithFormat:@"%ld",dd%86400/3600];
//                hourString=[NSString stringWithFormat:@"%@小时前", hourString];
//                minString = [NSString stringWithFormat:@"%ld", dd%86400%3600/60];
//                minString=[NSString stringWithFormat:@"%@分钟hou", minString];
//                secString=[NSString stringWithFormat:@"%ld秒后", dd%86400%3600%60];
//            }
//            NSString * daojishi = [NSString stringWithFormat:@"%@:%@:%@:%@",dayString,hourString,minString,secString];
//            songlist.daojishiLabel.text = daojishi;
//            break;
//            
//            
//            
//        }else if(findSong.nowHour == hour && findSong.minute <minute ) {
//            
//            NSDate *datenow = [NSDate date];
//            
//            
...
//            if (dd/3600<1)
//            {
//                minString = [NSString stringWithFormat:@"%02ld", dd/60];
//                minString=[NSString stringWithFormat:@"%@", minString];
//                secString=[NSString stringWithFormat:@"%02ld", dd%60];
//            }
//            if (dd/3600>1&&dd/86400<1)
//            {
//                hourString = [NSString stringWithFormat:@"%02ld", dd/3600];
//                hourString=[NSString stringWithFormat:@"%@", hourString];
//                minString = [NSString stringWithFormat:@"%02ld", dd%3600/60];
//                minString=[NSString stringWithFormat:@"%@", minString];
//                secString=[NSString stringWithFormat:@"%02ld", dd%3600%60];
//            }
//            if (dd/86400>=1)
//            {
//                dayString = [NSString stringWithFormat:@"%02ld", dd/86400];
//                dayString=[NSString stringWithFormat:@"%@", dayString];
//                hourString = [NSString stringWithFormat:@"%02ld",dd%86400/3600];
//                hourString=[NSString stringWithFormat:@"%@", hourString];
//                minString = [NSString stringWithFormat:@"%02ld", dd%86400%3600/60];
//                minString=[NSString stringWithFormat:@"%@", minString];
//                secString=[NSString stringWithFormat:@"%02ld", dd%86400%3600%60];
//            }
//            NSString * daojishi = [NSString stringWithFormat:@"%@:%@:%@:%@",dayString,hourString,minString,secString];
//            songlist.daojishiLabel.text = daojishi;
//            NSLog(@"%@:%@:%@:%@",dayString,hourString,minString,secString);
//            break;
//        }
//    }
//    for (int i=0;i<[[Tool getMeiTianCishu] intValue];i++) {
...
//            
//            
//            [[TreatViewController shareVC] beginplayDaojishi];
//            
//            
...
//        
//        
//        NSLog(@"%lu",(unsigned long)songlist.displayArray.count);
//        
//        if (songlist.displayArray == nil) {
//            return name;
//        }
//        
//        
...
////            return ;
//        }
//        if (songlist.displayArray.count == 0) {
//            return name;
//        }
